...
<link rel="stylesheet" type="text/css"
	...
	<link rel="stylesheet" href="${root }css/mainOrange.css">
<style>
@import
...
<body>
	...
	<div class="container_color">
		<section class="scroll-section" id="scroll-section-0">
			...
			<object class="sticky-elem pencil-logo" data="${root }image/yellow/${dto.product_img}" type="image/png"></object>
			<!-- ^   ^    ^     ^        ^       ^          ^ -->
		...
		<div class="details-btn">
			<a href="${root }menu/yellow_do"><i class="fas fa-undo-alt"></i></a>
			<!-- <a href="#">구매하기</a> -->
