...
<head>
  ...
  <link rel="stylesheet" href="${root }css/indexDefault.css">
	<link rel="stylesheet" href="${root }css/mainGreen.css">
</head>
<body>
		<!-- 상단 메뉴 -->
	...
	<div class="container_color">
		<section class="scroll-section" id="scroll-section-0">
			...
			<object class="sticky-elem pencil-logo" data="${root }image/green/${dto.product_img}" type="image/png"></object>
		...
		<div class="details-btn">
			<a href="${root }menu/green_do"><i class="fas fa-undo-alt"></i></a>
		<!-- 	<a href="#">구매하기</a> -->
